...
**Instructions:**
1.  Create a file named `DOCUMENTATION.md` in the root of your `nexus-ai` project folder.
2.  Copy the content below and paste it into that file.

# **Nexus AI: A Conversational News and Analysis Engine**

![Python](https://img.shields.io/badge/Python-3.12-blue?logo=python)![Docker](https://img.shields.io/badge/Docker-25-blue?logo=docker)![GCP](https://img.shields.io/badge/Google_Cloud-Deployed-blue?logo=google-cloud)![Generative AI](https://img.shields.io/badge/Generative_AI-LLM-orange)![NLP](https://img.shields.io/badge/NLP-spaCy-orange)![SQL](https://img.shields.io/badge/Database-SQLite-lightgrey)

**Live Demo URL:** [https://nexus-ai-service-671408180579.us-central1.run.app](https://nexus-ai-service-671408180579.us-central1.run.app)
...
1.  **Push the Docker Image:** The built image is pushed to Google Artifact Registry.
    ```bash
    # (After authentication and tagging)
    docker push us-central1-docker.pkg.dev/YOUR_PROJECT_ID/nexus-ai-repo/nexus-ai-app:latest
    ```
2.  **Deploy the Service:** The image is deployed using a `gcloud` command, with memory, CPU, and timeout settings appropriate for a memory-intensive AI application.
    ```bash
...
*   **Retrieval-Augmented Generation (RAG):** Instead of simply using a generic LLM, a RAG architecture was implemented. This grounds the AI's responses in factual data from the project's own database, reducing hallucinations and allowing the system to cite its sources.
